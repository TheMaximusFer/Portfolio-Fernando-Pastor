    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        livingGhostPositionDistributions = \
            [beliefs for i, beliefs in enumerate(self.ghostBeliefs)
             if livingGhosts[i+1]]
        "*** YOUR CODE HERE ***"
        # Distribución de posiciones más probables de cada fantasma vivo
        ...
        # Para cada acción legal, miramos a dónde iría Pacman.
        for action in legal:
            successorPosition = game.Actions.getSuccessor(pacmanPosition, action)

            # Distancia (mazeDistance) desde esa casilla al fantasma vivo más cercano.
