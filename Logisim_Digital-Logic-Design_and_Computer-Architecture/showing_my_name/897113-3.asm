...
P               .dw 80                          ; //Constante 80, la correspondiente a la P en ascii, nos servirá para escribir la mayúscula inicial del apellido.
                                                ; i = 0

.code                                           ; // @0
                mov cero, tty_out               ; //Borra pantalla.
                mov nombre, letra               ; letra = nombre[i]
                cmp cero, cero                  ; //Hacemos que la f sea mayúscula.
                beq NORMAL
...
NEXT:                           
                ...
                cmp minuscula_esp, letra        ; if(letra == ' ' || letra == 'P'){
