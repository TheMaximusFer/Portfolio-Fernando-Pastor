...
/* Plantilla $Revision$ */
/* Autor: Duarte Jauregui Fabrizio */
 ...
 *
 * @param[in] mensaje_servidor Mensaje recibido del servidor
 * @param[in] mensaje_cliente Mensaje enviado por el cliente
 * @return 1 si la respuesta es esperada, 0 en caso contrario
 */
