...
import EnderArchiveInfo from './pages/EnderArchiveInfo';
    ...
    <React.StrictMode>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/ender-archive-info" element={<EnderArchiveInfo />} />
          <Route path="/favorites" element={<Favorites />} />
          <Route path="/my-worlds" element={<MyWorlds />} />
          <Route path="/info" element={<EnderArchiveInfo />} />
          <Route path="/my-worlds/edit-world/:mapName" element={<WorldEdit />} />
