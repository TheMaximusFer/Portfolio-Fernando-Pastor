...
const EnderArchiveInfo = () => {
  return (
    <div>
      <h1>EnderArchive – Información del Sitio</h1>
      ...
      <section>
        ...
        <p>
          ...
          personal, desde el cual puede gestionar sus mundos, su información de
          usuario y su actividad dentro de la comunidad.
        </p>
        <p>
      ...
      <section>
        ...
        <ul>
          <li>
            Prohibido compartir información personal propia o de terceros.
          </li>
          <li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Todas las marcas registradas pertenecen a sus respectivos propietarios.</li>
      ...
      <section>
        <h2>Contacto</h2>
        <p>
          Para cualquier duda, incidencia o solicitud de soporte puedes
          escribirnos a:
        </p>
        <p>
          📧{" "}
